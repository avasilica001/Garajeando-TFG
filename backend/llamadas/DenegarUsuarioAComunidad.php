...
error_reporting(E_ALL);
        ...
        if($_SERVER['REQUEST_METHOD']=='POST'){
                if (isset($_POST['IdUsuario']) and isset($_POST['IdComunidad'])){
                        ...
                        if($bbdd->denegarUsuarioAComunidad($_POST['IdUsuario'],$_POST['IdComunidad'])){
                                $respuesta['error'] = false;
                                $respuesta['mensaje'] = "El usuario se ha denegado en la comunidad.";
                        }else{
                                $respuesta['error'] = true;
                                $respuesta['mensaje'] = "El usuario no se ha podido denegar en la comunidad.";
                        }
                }else{
                        $respuesta['error'] = true;
